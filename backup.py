...
TRADE_CHANNEL_ID = os.getenv('TRADE_CHANNEL_ID', '1361566428242645073')  # ID do canal específico para trades
...
# Dicionário para armazenar informações sobre códigos gerados
active_trades = {}

# Dicionário para armazenar trades disponíveis para usuários
user_trades = {}

# Dicionário para armazenar quando um usuário recebeu trades diários
daily_claim_cooldown = {}

# Dicionário para rastrear usuários com trades em andamento
