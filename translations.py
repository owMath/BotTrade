...
TRANSLATIONS = {
    ...
    'pt': {
        ...
        'giveaway_ended_desc': 'Prêmio: {prize}\n\nGanhadores: {winners}\n\nCada ganhador recebeu {prize} trade(s)!',
        ...
        'giveaway_dm': '🎉 Parabéns! Você ganhou **{trades}** ({prize}) no sorteio do servidor {server}!',
    ...
    'en': {
        ...
        'giveaway_ended_desc': 'Prize: {prize}\n\nWinners: {winners}\n\nEach winner received {prize} trade(s)!',
        ...
        'giveaway_dm': '🎉 Congratulations! You won **{trades}** ({prize}) in the giveaway on {server}!',
    ...
    'es': {
        ...
        'giveaway_ended_desc': 'Premio: {prize}\n\nGanadores: {winners}\n\n¡Cada ganador recibió {prize} trade(s)!',
        ...
        'giveaway_dm': '🎉 ¡Felicidades! Ganaste **{trades}** ({prize}) en el sorteo del servidor {server}!',
...
'fr': {
    ...
    'giveaway_ended_desc': 'Prix : {prize}\n\nGagnants : {winners}\n\nChaque gagnant a reçu {prize} trade(s) !',
    ...
    'giveaway_dm': '🎉 Félicitations ! Vous avez gagné **{trades}** ({prize}) lors du giveaway sur le serveur {server} !',
...
'de': {
    ...
    'giveaway_ended_desc': 'Preis: {prize}\n\nGewinner: {winners}\n\nJeder Gewinner hat {prize} Trade(s) erhalten!',
    ...
    'giveaway_dm': '🎉 Glückwunsch! Du hast **{trades}** ({prize}) im Giveaway auf dem Server {server} gewonnen!',
...
'it': {
    ...
    'giveaway_ended_desc': 'Premio: {prize}\n\nVincitori: {winners}\n\nOgni vincitore ha ricevuto {prize} trade!',
    ...
    'giveaway_dm': '🎉 Complimenti! Hai vinto **{trades}** ({prize}) nel giveaway sul server {server}!',
...
'pl': {
    ...
    'giveaway_ended_desc': 'Nagroda: {prize}\n\nZwycięzcy: {winners}\n\nKażdy zwycięzca otrzymał {prize} trade(ów)!',
    ...
    'giveaway_dm': '🎉 Gratulacje! Wygrałeś **{trades}** ({prize}) w losowaniu na serwerze {server}!',
