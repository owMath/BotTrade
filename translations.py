...
TRANSLATIONS = {
    ...
    'pt': {
        ...
        # Sistema Guess the Number
        'guess_game_title': '🎯 Adivinhe o Número',
        'guess_game_desc': 'Adivinhe o número entre **{min}** e **{max}** e ganhe **{trades}** trades!',
        'guess_instructions': '📋 Instruções',
        'guess_instructions_desc': 'Clique no botão abaixo para tentar adivinhar o número. Você tem apenas uma tentativa!',
        'guess_game_id': 'ID do Jogo: {id}',
        'guess_created_title': '✅ Jogo Criado',
        'guess_created_desc': 'Jogo iniciado no canal {channel} com ID: {id}',
        'guess_start_usage': 'Uso: !gg start <min> <max> <trades> <#canal>',
        'guess_invalid_numbers': 'Os números devem ser inteiros válidos.',
        'guess_invalid_range': 'O número mínimo deve ser menor que o máximo.',
        'guess_invalid_trades': 'A quantidade de trades deve ser entre 1 e 100.',
        'guess_invalid_channel': 'Canal inválido. Use: <#canal>',
        'guess_channel_not_found': 'Canal não encontrado.',
        'guess_hint_usage': 'Uso: !gg hint <first|last|number> <#canal>',
        'guess_no_active_game': 'Não há jogo ativo neste canal.',
        'guess_invalid_hint_type': 'Tipo de dica inválido. Use: first, last ou number',
        'guess_hint_title': '💡 Dica do Jogo',
        'guess_hint_first': 'O primeiro dígito do número é: **{digit}**',
        'guess_hint_last': 'O último dígito do número é: **{digit}**',
        'guess_hint_digits': 'O número tem **{digits}** dígito(s).',
        'guess_hint_footer': 'Dica fornecida pelo administrador',
        'guess_hint_sent': '✅ Dica enviada com sucesso!',
        'guess_setup_usage': 'Uso: !gg setup <dm|lock-role> <enable|disable|role_id>',
        'guess_dm_enabled': '✅ DMs habilitadas para ganhadores.',
        'guess_dm_disabled': '❌ DMs desabilitadas para ganhadores.',
        'guess_invalid_dm_setting': 'Configuração inválida. Use: enable ou disable',
        'guess_lock_role_set': '✅ Role de bloqueio definido: {role}',
        'guess_role_not_found': 'Role não encontrado.',
        'guess_invalid_role_id': 'ID do role inválido.',
        'guess_invalid_setting': 'Configuração inválida. Use: dm ou lock-role',
        'guess_end_usage': 'Uso: !gg end <#canal>',
        'guess_end_success': '✅ Jogo encerrado com sucesso!',
        'guess_ended_title': '🏁 Jogo Encerrado',
        'guess_ended_desc': 'O jogo foi encerrado. O número era **{number}** e houve **{attempts}** tentativa(s).',
        'guess_winner': '🏆 Ganhador',
        'guess_no_winner': '😢 Sem Ganhador',
        'guess_no_winner_desc': 'Ninguém acertou o número antes do encerramento.',
        'guess_game_ended': 'Este jogo já foi encerrado.',
        'guess_no_role': 'Você não tem o role necessário para participar.',
        'guess_already_tried': 'Você já tentou adivinhar o número neste jogo.',
        'guess_invalid_number': 'Por favor, digite um número válido.',
        'guess_out_of_range': 'O número deve estar entre {min} e {max}.',
        'guess_win_title': '🎉 Parabéns! Você Acertou!',
        'guess_win_desc': '{user} acertou o número **{number}** e ganhou **{trades}** trades!',
        'guess_win_dm_title': '🎯 Você Ganhou!',
        'guess_win_dm_desc': 'Parabéns! Você acertou o número **{number}** e ganhou **{trades}** trades!\n\nTotal de trades: **{total}**',
        'guess_wrong_title': '❌ Não foi dessa vez...',
        'guess_wrong_desc': 'Seu palpite foi **{guess}**.\n\n💡 **Dica:** {hint}',
        'guess_hint_higher': 'O número é **maior** que seu palpite.',
        'guess_hint_lower': 'O número é **menor** que seu palpite.',
        'guess_invalid_action': 'Ação inválida. Use: start, hint, setup ou end',
        'guess_modal_title': '🎯 Adivinhar o Número',
        'guess_modal_label': 'Digite seu palpite',
        'guess_modal_placeholder': 'Ex: 42',
        ...
        'guess_button_label': '🎯 Tentar Adivinhar',
    },
    ...
    'en': {
        ...
        # Sistema Guess the Number
        'guess_game_title': '🎯 Guess the Number',
        'guess_game_desc': 'Guess the number between **{min}** and **{max}** and win **{trades}** trades!',
        'guess_instructions': '📋 Instructions',
        'guess_instructions_desc': 'Click the button below to try to guess the number. You only have one attempt!',
        'guess_game_id': 'Game ID: {id}',
        'guess_created_title': '✅ Game Created',
        'guess_created_desc': 'Game started in channel {channel} with ID: {id}',
        'guess_start_usage': 'Usage: !gg start <min> <max> <trades> <#channel>',
        'guess_invalid_numbers': 'Numbers must be valid integers.',
        'guess_invalid_range': 'The minimum number must be less than the maximum.',
        'guess_invalid_trades': 'The number of trades must be between 1 and 100.',
        'guess_invalid_channel': 'Invalid channel. Use: <#channel>',
        'guess_channel_not_found': 'Channel not found.',
        'guess_hint_usage': 'Usage: !gg hint <first|last|number> <#channel>',
        'guess_no_active_game': 'There is no active game in this channel.',
        'guess_invalid_hint_type': 'Invalid hint type. Use: first, last or number',
        'guess_hint_title': '💡 Game Hint',
        'guess_hint_first': 'The first digit of the number is: **{digit}**',
        'guess_hint_last': 'The last digit of the number is: **{digit}**',
        'guess_hint_digits': 'The number has **{digits}** digit(s).',
        'guess_hint_footer': 'Hint provided by administrator',
        'guess_hint_sent': '✅ Hint sent successfully!',
        'guess_setup_usage': 'Usage: !gg setup <dm|lock-role> <enable|disable|role_id>',
        'guess_dm_enabled': '✅ DMs enabled for winners.',
        'guess_dm_disabled': '❌ DMs disabled for winners.',
        'guess_invalid_dm_setting': 'Invalid setting. Use: enable or disable',
        'guess_lock_role_set': '✅ Lock role set: {role}',
        'guess_role_not_found': 'Role not found.',
        'guess_invalid_role_id': 'Invalid role ID.',
        'guess_invalid_setting': 'Invalid setting. Use: dm or lock-role',
        'guess_end_usage': 'Usage: !gg end <#channel>',
        'guess_end_success': '✅ Game ended successfully!',
        'guess_ended_title': '🏁 Game Ended',
        'guess_ended_desc': 'The game has ended. The number was **{number}** and there were **{attempts}** attempt(s).',
        'guess_winner': '🏆 Winner',
        'guess_no_winner': '😢 No Winner',
        'guess_no_winner_desc': 'No one guessed the number before the end.',
        'guess_game_ended': 'This game has already ended.',
        'guess_no_role': 'You do not have the required role to participate.',
        'guess_already_tried': 'You have already tried to guess the number in this game.',
        'guess_invalid_number': 'Please enter a valid number.',
        'guess_out_of_range': 'The number must be between {min} and {max}.',
        'guess_win_title': '🎉 Congratulations! You Got It Right!',
        'guess_win_desc': '{user} guessed the number **{number}** and won **{trades}** trades!',
        'guess_win_dm_title': '🎯 You Won!',
        'guess_win_dm_desc': 'Congratulations! You guessed the number **{number}** and won **{trades}** trades!\n\nTotal trades: **{total}**',
        'guess_wrong_title': '❌ Not this time...',
        'guess_wrong_desc': 'Your guess was **{guess}**.\n\n💡 **Hint:** {hint}',
        'guess_hint_higher': 'The number is **higher** than your guess.',
        'guess_hint_lower': 'The number is **lower** than your guess.',
        'guess_invalid_action': 'Invalid action. Use: start, hint, setup or end',
        'guess_modal_title': '🎯 Guess the Number',
        'guess_modal_label': 'Enter your guess',
        'guess_modal_placeholder': 'Ex: 42',
        ...
        'guess_button_label': '🎯 Try to Guess',
    },
    ...
    'es': {
        ...
        # Sistema Guess the Number
        'guess_game_title': '🎯 Adivina el Número',
        'guess_game_desc': '¡Adivina el número entre **{min}** y **{max}** y gana **{trades}** trades!',
        'guess_instructions': '📋 Instrucciones',
        'guess_instructions_desc': '¡Haz clic en el botón de abajo para intentar adivinar el número. Solo tienes un intento!',
        'guess_game_id': 'ID del Juego: {id}',
        'guess_created_title': '✅ Juego Creado',
        'guess_created_desc': 'Juego iniciado en el canal {channel} con ID: {id}',
        'guess_start_usage': 'Uso: !gg start <min> <max> <trades> <#canal>',
        'guess_invalid_numbers': 'Los números deben ser enteros válidos.',
        'guess_invalid_range': 'El número mínimo debe ser menor que el máximo.',
        'guess_invalid_trades': 'La cantidad de trades debe estar entre 1 y 100.',
        'guess_invalid_channel': 'Canal inválido. Usa: <#canal>',
        'guess_channel_not_found': 'Canal no encontrado.',
        'guess_hint_usage': 'Uso: !gg hint <first|last|number> <#canal>',
        'guess_no_active_game': 'No hay juego activo en este canal.',
        'guess_invalid_hint_type': 'Tipo de pista inválido. Usa: first, last o number',
        'guess_hint_title': '💡 Pista del Juego',
        'guess_hint_first': 'El primer dígito del número es: **{digit}**',
        'guess_hint_last': 'El último dígito del número es: **{digit}**',
        'guess_hint_digits': 'El número tiene **{digits}** dígito(s).',
        'guess_hint_footer': 'Pista proporcionada por el administrador',
        'guess_hint_sent': '✅ ¡Pista enviada con éxito!',
        'guess_setup_usage': 'Uso: !gg setup <dm|lock-role> <enable|disable|role_id>',
        'guess_dm_enabled': '✅ DMs habilitadas para ganadores.',
        'guess_dm_disabled': '❌ DMs deshabilitadas para ganadores.',
        'guess_invalid_dm_setting': 'Configuración inválida. Usa: enable o disable',
        'guess_lock_role_set': '✅ Rol de bloqueo establecido: {role}',
        'guess_role_not_found': 'Rol no encontrado.',
        'guess_invalid_role_id': 'ID de rol inválido.',
        'guess_invalid_setting': 'Configuración inválida. Usa: dm o lock-role',
        'guess_end_usage': 'Uso: !gg end <#canal>',
        'guess_end_success': '✅ ¡Juego terminado con éxito!',
        'guess_ended_title': '🏁 Juego Terminado',
        'guess_ended_desc': 'El juego ha terminado. El número era **{number}** y hubo **{attempts}** intento(s).',
        'guess_winner': '🏆 Ganador',
        'guess_no_winner': '😢 Sin Ganador',
        'guess_no_winner_desc': 'Nadie adivinó el número antes del final.',
        'guess_game_ended': 'Este juego ya ha terminado.',
        'guess_no_role': 'No tienes el rol necesario para participar.',
        'guess_already_tried': 'Ya intentaste adivinar el número en este juego.',
        'guess_invalid_number': 'Por favor, ingresa un número válido.',
        'guess_out_of_range': 'El número debe estar entre {min} y {max}.',
        'guess_win_title': '🎉 ¡Felicidades! ¡Lo Adivinaste!',
        'guess_win_desc': '¡{user} adivinó el número **{number}** y ganó **{trades}** trades!',
        'guess_win_dm_title': '🎯 ¡Ganaste!',
        'guess_win_dm_desc': '¡Felicidades! ¡Adivinaste el número **{number}** y ganaste **{trades}** trades!\n\nTotal de trades: **{total}**',
        'guess_wrong_title': '❌ No fue esta vez...',
        'guess_wrong_desc': 'Tu suposición fue **{guess}**.\n\n💡 **Pista:** {hint}',
        'guess_hint_higher': 'El número es **mayor** que tu suposición.',
        'guess_hint_lower': 'El número es **menor** que tu suposición.',
        'guess_invalid_action': 'Acción inválida. Usa: start, hint, setup o end',
        'guess_modal_title': '🎯 Adivina el Número',
        'guess_modal_label': 'Escribe tu respuesta',
        'guess_modal_placeholder': 'Ej: 42',
        ...
        'guess_button_label': '🎯 Intentar Adivinar',
    },
    ...
    'fr': {
        ...
        # Sistema Guess the Number
        'guess_game_title': '🎯 Devinez le Nombre',
        'guess_game_desc': 'Devinez le nombre entre **{min}** et **{max}** et gagnez **{trades}** trades !',
        'guess_instructions': '📋 Instructions',
        'guess_instructions_desc': 'Cliquez sur le bouton ci-dessous pour essayer de deviner le nombre. Vous n\'avez qu\'une seule tentative !',
        'guess_game_id': 'ID du Jeu : {id}',
        'guess_created_title': '✅ Jeu Créé',
        'guess_created_desc': 'Jeu démarré dans le canal {channel} avec l\'ID : {id}',
        'guess_start_usage': 'Utilisation : !gg start <min> <max> <trades> <#canal>',
        'guess_invalid_numbers': 'Les nombres doivent être des entiers valides.',
        'guess_invalid_range': 'Le nombre minimum doit être inférieur au maximum.',
        'guess_invalid_trades': 'Le nombre de trades doit être entre 1 et 100.',
        'guess_invalid_channel': 'Canal invalide. Utilisez : <#canal>',
        'guess_channel_not_found': 'Canal non trouvé.',
        'guess_hint_usage': 'Utilisation : !gg hint <first|last|number> <#canal>',
        'guess_no_active_game': 'Il n\'y a pas de jeu actif dans ce canal.',
        'guess_invalid_hint_type': 'Type d\'indice invalide. Utilisez : first, last ou number',
        'guess_hint_title': '💡 Indice du Jeu',
        'guess_hint_first': 'Le premier chiffre du nombre est : **{digit}**',
        'guess_hint_last': 'Le dernier chiffre du nombre est : **{digit}**',
        'guess_hint_digits': 'Le nombre a **{digits}** chiffre(s).',
        'guess_hint_footer': 'Indice fourni par l\'administrateur',
        'guess_hint_sent': '✅ Indice envoyé avec succès !',
        'guess_setup_usage': 'Utilisation : !gg setup <dm|lock-role> <enable|disable|role_id>',
        'guess_dm_enabled': '✅ DMs activées pour les gagnants.',
        'guess_dm_disabled': '❌ DMs désactivées pour les gagnants.',
        'guess_invalid_dm_setting': 'Paramètre invalide. Utilisez : enable ou disable',
        'guess_lock_role_set': '✅ Rôle de verrouillage défini : {role}',
        'guess_role_not_found': 'Rôle non trouvé.',
        'guess_invalid_role_id': 'ID de rôle invalide.',
        'guess_invalid_setting': 'Paramètre invalide. Utilisez : dm ou lock-role',
        'guess_end_usage': 'Utilisation : !gg end <#canal>',
        'guess_end_success': '✅ Jeu terminé avec succès !',
        'guess_ended_title': '🏁 Jeu Terminé',
        'guess_ended_desc': 'Le jeu est terminé. Le nombre était **{number}** et il y a eu **{attempts}** tentative(s).',
        'guess_winner': '🏆 Gagnant',
        'guess_no_winner': '😢 Pas de Gagnant',
        'guess_no_winner_desc': 'Personne n\'a deviné le nombre avant la fin.',
        'guess_game_ended': 'Ce jeu est déjà terminé.',
        'guess_no_role': 'Vous n\'avez pas le rôle requis pour participer.',
        'guess_already_tried': 'Vous avez déjà essayé de deviner le nombre dans ce jeu.',
        'guess_invalid_number': 'Veuillez entrer un nombre valide.',
        'guess_out_of_range': 'Le nombre doit être entre {min} et {max}.',
        'guess_win_title': '🎉 Félicitations ! Vous avez trouvé !',
        'guess_win_desc': '{user} a deviné le nombre **{number}** et gagné **{trades}** trades !',
        'guess_win_dm_title': '🎯 Vous avez gagné !',
        'guess_win_dm_desc': 'Félicitations ! Vous avez deviné le nombre **{number}** et gagné **{trades}** trades !\n\nTotal des trades : **{total}**',
        'guess_wrong_title': '❌ Pas cette fois...',
        'guess_wrong_desc': 'Votre supposition était **{guess}**.\n\n�� **Indice :** {hint}',
        'guess_hint_higher': 'Le nombre est **plus élevé** que votre supposition.',
        'guess_hint_lower': 'Le nombre est **plus bas** que votre supposition.',
        'guess_invalid_action': 'Action invalide. Utilisez : start, hint, setup ou end',
        'guess_modal_title': '🎯 Devine le Nombre',
        'guess_modal_label': 'Entrez votre proposition',
        'guess_modal_placeholder': 'Ex : 42',
    ...
    'de': {
        ...
        # Sistema Guess the Number
        'guess_game_title': '🎯 Rate die Zahl',
        'guess_game_desc': 'Rate die Zahl zwischen **{min}** und **{max}** und gewinne **{trades}** Trades!',
        'guess_instructions': '📋 Anweisungen',
        'guess_instructions_desc': 'Klicke auf den Button unten, um die Zahl zu erraten. Du hast nur einen Versuch!',
        'guess_game_id': 'Spiel-ID: {id}',
        'guess_created_title': '✅ Spiel Erstellt',
        'guess_created_desc': 'Spiel im Kanal {channel} mit ID: {id} gestartet',
        'guess_start_usage': 'Verwendung: !gg start <min> <max> <trades> <#kanal>',
        'guess_invalid_numbers': 'Zahlen müssen gültige Ganzzahlen sein.',
        'guess_invalid_range': 'Die Mindestzahl muss kleiner als das Maximum sein.',
        'guess_invalid_trades': 'Die Anzahl der Trades muss zwischen 1 und 100 liegen.',
        'guess_invalid_channel': 'Ungültiger Kanal. Verwende: <#kanal>',
        'guess_channel_not_found': 'Kanal nicht gefunden.',
        'guess_hint_usage': 'Verwendung: !gg hint <first|last|number> <#kanal>',
        'guess_no_active_game': 'Es gibt kein aktives Spiel in diesem Kanal.',
        'guess_invalid_hint_type': 'Ungültiger Hinweistyp. Verwende: first, last oder number',
        'guess_hint_title': '💡 Spielhinweis',
        'guess_hint_first': 'Die erste Ziffer der Zahl ist: **{digit}**',
        'guess_hint_last': 'Die letzte Ziffer der Zahl ist: **{digit}**',
        'guess_hint_digits': 'Die Zahl hat **{digits}** Ziffer(n).',
        'guess_hint_footer': 'Hinweis vom Administrator',
        'guess_hint_sent': '✅ Hinweis erfolgreich gesendet!',
        'guess_setup_usage': 'Verwendung: !gg setup <dm|lock-role> <enable|disable|role_id>',
        'guess_dm_enabled': '✅ DMs für Gewinner aktiviert.',
        'guess_dm_disabled': '❌ DMs für Gewinner deaktiviert.',
        'guess_invalid_dm_setting': 'Ungültige Einstellung. Verwende: enable oder disable',
        'guess_lock_role_set': '✅ Sperrrolle festgelegt: {role}',
        'guess_role_not_found': 'Rolle nicht gefunden.',
        'guess_invalid_role_id': 'Ungültige Rollen-ID.',
        'guess_invalid_setting': 'Ungültige Einstellung. Verwende: dm oder lock-role',
        'guess_end_usage': 'Verwendung: !gg end <#kanal>',
        'guess_end_success': '✅ Spiel erfolgreich beendet!',
        'guess_ended_title': '🏁 Spiel Beendet',
        'guess_ended_desc': 'Das Spiel ist beendet. Die Zahl war **{number}** und es gab **{attempts}** Versuch(e).',
        'guess_winner': '🏆 Gewinner',
        'guess_no_winner': '😢 Kein Gewinner',
        'guess_no_winner_desc': 'Niemand hat die Zahl vor dem Ende erraten.',
        'guess_game_ended': 'Dieses Spiel ist bereits beendet.',
        'guess_no_role': 'Du hast nicht die erforderliche Rolle zur Teilnahme.',
        'guess_already_tried': 'Du hast bereits versucht, die Zahl in diesem Spiel zu erraten.',
        'guess_invalid_number': 'Bitte gib eine gültige Zahl ein.',
        'guess_out_of_range': 'Die Zahl muss zwischen {min} und {max} liegen.',
        'guess_win_title': '🎉 Glückwunsch! Du hast es erraten!',
        'guess_win_desc': '{user} hat die Zahl **{number}** erraten und **{trades}** Trades gewonnen!',
        ...
        'guess_invalid_action': 'Ungültige Aktion. Verwende: start, hint, setup oder end',
        'guess_modal_title': '🎯 Zahl erraten',
        'guess_modal_label': 'Gib deinen Tipp ein',
        'guess_modal_placeholder': 'z.B.: 42',
    ...
    'it': {
        ...
        # Sistema Guess the Number
        'guess_game_title': '🎯 Indovina il Numero',
        'guess_game_desc': 'Indovina il numero tra **{min}** e **{max}** e vinci **{trades}** trades!',
        'guess_instructions': '📋 Istruzioni',
        'guess_instructions_desc': 'Clicca il pulsante qui sotto per provare a indovinare il numero. Hai solo un tentativo!',
        'guess_game_id': 'ID del Gioco: {id}',
        'guess_created_title': '✅ Gioco Creato',
        'guess_created_desc': 'Gioco avviato nel canale {channel} con ID: {id}',
        'guess_start_usage': 'Uso: !gg start <min> <max> <trades> <#canale>',
        'guess_invalid_numbers': 'I numeri devono essere interi validi.',
        'guess_invalid_range': 'Il numero minimo deve essere inferiore al massimo.',
        'guess_invalid_trades': 'Il numero di trades deve essere tra 1 e 100.',
        'guess_invalid_channel': 'Canale non valido. Usa: <#canale>',
        'guess_channel_not_found': 'Canale non trovato.',
        'guess_hint_usage': 'Uso: !gg hint <first|last|number> <#canale>',
        'guess_no_active_game': 'Non c\'è un gioco attivo in questo canale.',
        'guess_invalid_hint_type': 'Tipo di suggerimento non valido. Usa: first, last o number',
        'guess_hint_title': '💡 Suggerimento del Gioco',
        'guess_hint_first': 'La prima cifra del numero è: **{digit}**',
        'guess_hint_last': 'L\'ultima cifra del numero è: **{digit}**',
        'guess_hint_digits': 'Il numero ha **{digits}** cifra(e).',
        'guess_hint_footer': 'Suggerimento fornito dall\'amministratore',
        'guess_hint_sent': '✅ Suggerimento inviato con successo!',
        'guess_setup_usage': 'Uso: !gg setup <dm|lock-role> <enable|disable|role_id>',
        'guess_dm_enabled': '✅ DM abilitate per i vincitori.',
        'guess_dm_disabled': '❌ DM disabilitate per i vincitori.',
        'guess_invalid_dm_setting': 'Impostazione non valida. Usa: enable o disable',
        'guess_lock_role_set': '✅ Ruolo di blocco impostato: {role}',
        'guess_role_not_found': 'Ruolo non trovato.',
        'guess_invalid_role_id': 'ID ruolo non valido.',
        'guess_invalid_setting': 'Impostazione non valida. Usa: dm o lock-role',
        'guess_end_usage': 'Uso: !gg end <#canale>',
        'guess_end_success': '✅ Gioco terminato con successo!',
        'guess_ended_title': '🏁 Gioco Terminato',
        'guess_ended_desc': 'Il gioco è terminato. Il numero era **{number}** e ci sono stati **{attempts}** tentativo(i).',
        'guess_winner': '🏆 Vincitore',
        'guess_no_winner': '😢 Nessun Vincitore',
        'guess_no_winner_desc': 'Nessuno ha indovinato il numero prima della fine.',
        'guess_game_ended': 'Questo gioco è già terminato.',
        'guess_no_role': 'Non hai il ruolo richiesto per partecipare.',
        'guess_already_tried': 'Hai già provato a indovinare il numero in questo gioco.',
        'guess_invalid_number': 'Inserisci un numero valido.',
        'guess_out_of_range': 'Il numero deve essere tra {min} e {max}.',
        'guess_win_title': '🎉 Congratulazioni! Hai indovinato!',
        'guess_win_desc': '{user} ha indovinato il numero **{number}** e vinto **{trades}** trades!',
        ...
        'guess_invalid_action': 'Azione non valida. Usa: start, hint, setup o end',
        'guess_modal_title': '🎯 Indovina il Numero',
        'guess_modal_label': 'Inserisci la tua risposta',
        'guess_modal_placeholder': 'Es: 42',
    ...
    'pl': {
        ...
        # Sistema Guess the Number
        'guess_game_title': '🎯 Zgadnij Liczbę',
        'guess_game_desc': 'Zgadnij liczbę między **{min}** a **{max}** i wygraj **{trades}** trades!',
        'guess_instructions': '📋 Instrukcje',
        'guess_instructions_desc': 'Kliknij przycisk poniżej, aby spróbować zgadnąć liczbę. Masz tylko jedną próbę!',
        'guess_game_id': 'ID Gry: {id}',
        'guess_created_title': '✅ Gra Utworzona',
        'guess_created_desc': 'Gra rozpoczęta na kanale {channel} z ID: {id}',
        'guess_start_usage': 'Użycie: !gg start <min> <max> <trades> <#kanał>',
        'guess_invalid_numbers': 'Liczby muszą być prawidłowymi liczbami całkowitymi.',
        'guess_invalid_range': 'Liczba minimalna musi być mniejsza niż maksymalna.',
        'guess_invalid_trades': 'Liczba trades musi być między 1 a 100.',
        'guess_invalid_channel': 'Nieprawidłowy kanał. Użyj: <#kanał>',
        'guess_channel_not_found': 'Kanał nie znaleziony.',
        'guess_hint_usage': 'Użycie: !gg hint <first|last|number> <#kanał>',
        'guess_no_active_game': 'Nie ma aktywnej gry na tym kanale.',
        'guess_invalid_hint_type': 'Nieprawidłowy typ podpowiedzi. Użyj: first, last lub number',
        'guess_hint_title': '💡 Podpowiedź Gry',
        'guess_hint_first': 'Pierwsza cyfra liczby to: **{digit}**',
        'guess_hint_last': 'Ostatnia cyfra liczby to: **{digit}**',
        'guess_hint_digits': 'Liczba ma **{digits}** cyfr(y).',
        'guess_hint_footer': 'Podpowiedź dostarczona przez administratora',
        'guess_hint_sent': '✅ Podpowiedź wysłana pomyślnie!',
        'guess_setup_usage': 'Użycie: !gg setup <dm|lock-role> <enable|disable|role_id>',
        'guess_dm_enabled': '✅ DM włączone dla zwycięzców.',
        'guess_dm_disabled': '❌ DM wyłączone dla zwycięzców.',
        'guess_invalid_dm_setting': 'Nieprawidłowe ustawienie. Użyj: enable lub disable',
        'guess_lock_role_set': '✅ Rola blokująca ustawiona: {role}',
        'guess_role_not_found': 'Rola nie znaleziona.',
        'guess_invalid_role_id': 'Nieprawidłowe ID roli.',
        'guess_invalid_setting': 'Nieprawidłowe ustawienie. Użyj: dm lub lock-role',
        'guess_end_usage': 'Użycie: !gg end <#kanał>',
        'guess_end_success': '✅ Gra zakończona pomyślnie!',
        'guess_ended_title': '🏁 Gra Zakończona',
        'guess_ended_desc': 'Gra się zakończyła. Liczba to **{number}** i było **{attempts}** prób(y).',
        'guess_winner': '🏆 Zwycięzca',
        'guess_no_winner': '😢 Brak Zwycięzcy',
        'guess_no_winner_desc': 'Nikt nie zgadł liczby przed końcem.',
        'guess_game_ended': 'Ta gra już się zakończyła.',
        'guess_no_role': 'Nie masz wymaganej roli do udziału.',
        'guess_already_tried': 'Już próbowałeś zgadnąć liczbę w tej grze.',
        'guess_invalid_number': 'Wprowadź prawidłową liczbę.',
        'guess_out_of_range': 'Liczba musi być między {min} a {max}.',
        'guess_win_title': '🎉 Gratulacje! Zgadłeś!',
        'guess_win_desc': '{user} zgadł liczbę **{number}** i wygrał **{trades}** trades!',
        ...
        'guess_invalid_acnotion': 'Nieprawidłowa akcja. Użyj: start, hint, setup lub end',
        'guess_modal_title': '🎯 Zgadnij Liczbę',
        'guess_modal_label': 'Wpisz swoją odpowiedź',
        'guess_modal_placeholder': 'Np: 42',
...
def t(key, lang=None, params=None):
    """Obtém uma tradução baseada na chave e idioma"""
    ...
    if key not in TRANSLATIONS[lang]:
        # Fallback para português se a chave não existir no idioma solicitado
        if key in TRANSLATIONS['pt']:
            translation = TRANSLATIONS['pt'][key]
        else:
            return f"[{key}]"  # Retorna a chave se não encontrar tradução
    else:
    ...
    if params:
        try:
            ...
            # Se houver erro na formatação, retorna a tradução sem formatação
            pass
